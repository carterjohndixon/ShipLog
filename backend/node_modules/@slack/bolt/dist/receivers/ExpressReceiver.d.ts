...
export interface ExpressReceiverOptions {
    ...
    dispatchErrorHandler?: (
        args: httpFunc.ReceiverDispatchErrorHandlerArgs,
    ) => Promise<void>;
    processEventErrorHandler?: (
        args: httpFunc.ReceiverProcessEventErrorHandlerArgs,
    ) => Promise<boolean>;
    unhandledRequestHandler?: (
        args: httpFunc.ReceiverUnhandledRequestHandlerArgs,
    ) => void;
...
interface InstallerOptions {
    ...
    stateCookieExpirationSeconds?:
        InstallProviderOptions["stateCookieExpirationSeconds"];
...
export declare function verifySignatureAndParseRawBody(
    logger: Logger,
    signingSecret: string | (() => PromiseLike<string>),
): RequestHandler;
/**
 ...
 */
export declare function verifySignatureAndParseBody(
    signingSecret: string,
    body: string,
    headers: Record<string, any>,
): AnyMiddlewareArgs["body"];
export declare function buildBodyParserMiddleware(
    logger: Logger,
): RequestHandler;
export {};
